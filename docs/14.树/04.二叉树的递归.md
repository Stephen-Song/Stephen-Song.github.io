...
## lc104. 二叉树的最大深度<Badge text="滴滴 简单" vertical="top"/><badge text="hot" type="error"/>
...
## lc110. 平衡二叉树<Badge text="简单" vertical="top"/><badge text="hot" type="error"/>
...
## lc226. 翻转二叉树<Badge text="简单" vertical="top"/><badge text="hot" type="error"/>
...
## lc105. 从前序与中序序列构造二叉树<Badge text="中等" vertical="top"/><badge text="hot" type="error"/>
...
## lc106. 从中序与后序序列构造二叉树<Badge text="中等" vertical="top"/><badge text="hot" type="error"/>
...
## lc889. 从前序与后序序列构造二叉树<Badge text="中等" vertical="top"/><badge text="hot" type="error"/>
...
## lc236. 二叉树最近公共祖先<Badge text="中等" vertical="top"/><badge text="hot" type="error"/>
...
## lc112. 路径之和<Badge text="简单" vertical="top"/><badge text="hot" type="error" />
...
## 求二叉树和为`target`的所有路径<badge text="hot" type="error" />
...
const treeSum = (root, target) => {
  ...
  const FindPath = (node, currentSum, path) => {
    ...
    if (root.left) treeSum(root.left, currentSum, path);
    if (root.right) treeSum(root.right, currentSum, path);
    // 回溯 撤销操作
    path.pop();
  };
...
## lc101. 对称二叉树<Badge text="简单" vertical="top"/><badge text="hot" type="error" />
...
## lc450. 删除二叉搜索树中的节点<Badge text="中等" vertical="top"/>
